...
async function main() {
	...
	try {
		user3 = await userData.create('Joe', 'Doe', 'joe@gmail.com', 'Joe@2023', 'user');
	} catch (e) {
		console.log(e);
	}

	try {
		user4 = await userData.create('Jone', 'Doe', 'jdone@gmail.com', 'Jdone@2023', 'user');
	} catch (e) {
		console.log(e);
	}

	try {
		user5 = await userData.create('jerry', 'gill', 'gill@gmail.com', 'Gill@2023', 'user');
	} catch (e) {
		console.log(e);
	}
	...
	try {
		manager3 = await userData.create('lane', 'Parker', 'lparker@gmail.com', 'parkIt@1998', 'hotel');
	} catch (e) {
		console.log(e);
	}
